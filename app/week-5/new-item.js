...
export default function NewItem() {
    ...
    const handleSubmit = (e) => {
        ...
        if (itemName || category) {
            alert(`Added item: ${itemName}, quantity: ${count}, category: ${category.toLowerCase()}`);
        }else{
    ...
    return (
        <form onSubmit={handleSubmit} className="p-2 m-4 bg-slate-900 h-48 rounded-lg text-black max-w-sm w-full">
        <div className="mb-2">
            <input 
            type="text"
            ...
            <div className="p-2 m-1 rounded-md  bg-white text-white w-36">
                ...
                <div className="flex">
                <button type="button" onClick={decrement} className="w-8 bg-blue-500 text-white font-semibold
                ...
                <button type="button" onClick={increment} className="w-8 bg-blue-500 text-white font-semibold
                rounded-lg shadow-md hover:bg-blue-700 focus:outline-none focus:ring-2
